...
function Hero() {
  return (
    <div className=" isolate container mx-auto flex px-5 md:py-24 md:flex-row flex-col items-center relative pt-40">
      <HeroBody />
      ...
      <img
        src={svgImg}
        alt="Svg image"
        className="hidden md:block absolute right-0 xl:w-1/2 2xl:w-5/12 lg:w-[60%] md:w-[55%] -z-10"
      />
    </div>
  );
}
