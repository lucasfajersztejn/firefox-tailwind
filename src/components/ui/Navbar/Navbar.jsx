    ...
    <nav className="z-20 bg-white dark:bg-slate-800 fixed md:static w-full md:w-auto border-b md:border-none shadow-lg md:shadow-none dark:border-none">
      <div className="p-6 container mx-auto">
        <div className="flex items-center justify-between">
          <div className="z-20 mx-auto lg:mx-0">
            <a href="" className="flex items-center">
              <img src={firefoxImage} alt="Logo image" className="w-14 h-14"/>
              <span className="text-3xl ml-3 md:hidden lg:block"> <span className="font-bold">Firefox</span> Browser </span>
            </a>
          </div>
                ...
                <label className="flex cursor-pointer gap-2">
                  {window.matchMedia("(prefers-color-scheme: dark)").matches ? (
                    <>
                      ...
                      <input onClick={onDarkMode} type="checkbox" value="synthwave" className="toggle theme-controller"/>
